  ...
  <nav aria-label="breadcrumb">
    ...
    ?>
      <form class="d-flex" action="" method="post">
        ...
        <input type="hidden" name="membre" value="<?php echo $_SESSION['id_projet_membre']?>">
        <button type="submit" class = "coeur"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16" id="heart">
      ...
      if (isset( $_POST['fiche']) AND isset( $_POST['membre'])){
        ...
        if ($nombreReponses==0)
        {
          $requete="INSERT INTO projet_membre_fiche (id_membre,id_fiche) VALUES (?, ?)";
          $reponse=$pdo->prepare($requete);
          $reponse->execute(array($membre, $fiche));
        }
      }
